 ...
 * You can add an optional custom header image to header.php like so ...
	...
	if ( ! empty( $header_image ) ) { ?>
		<a href="<?php echo esc_url( echo get_home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
...
?>
	<div id="headimg">
		<h1 class="displaying-header-text"><a id="name"<?php echo $style; ?> onclick="return false;" href="<?php echo esc_url( echo get_home_url( '/' ) ); ?>"><?php bloginfo( 'name' ); ?></a></h1>
