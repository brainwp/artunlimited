...
class Odin_Metabox {
	...
	public function scripts() {
		...
		if ( in_array( $screen->id, $this->get_post_type() ) ) {
			...
			// Metabox.
			wp_enqueue_script( 'odin-admin', get_template_directory_uri() . '/assets/odin/js/admin.js', array( 'jquery' ), null, true );
			wp_enqueue_style( 'odin-admin', get_template_directory_uri() . '/assets/odin/css/admin.css', array(), null, 'all' );
