...
function artunlimited_scripts() {
	...
	wp_enqueue_script( 'vendor-head', get_stylesheet_directory_uri() . '/js/vendor-head.js' );
    wp_enqueue_script( 'vendor', get_stylesheet_directory_uri() . '/js/vendor.js', array(), null, true );
